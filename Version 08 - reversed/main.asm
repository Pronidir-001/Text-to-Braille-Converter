...
;<label>		<opcode>		<operand>				
				...
				.equ			LED_DDR		 =	DDRB
				.equ			LED_PINS	 =	0x3F
				.equ			BUFFER_SIZE	 =	32			;store upto 32 characters
...
BrailleTable:	
				.db	0b111110, 0b111010, 0b111100, 0b110100, 0b110110, 0b111000, 0b110000, 0b110010, 0b111001, 0b110001
				.db	0b101110, 0b101010, 0b101100, 0b100100, 0b100110, 0b101000, 0b100000, 0b100010, 0b101001, 0b100001
				.db	0b001110, 0b001010, 0b010001, 0b001100, 0b000100, 0b000110
;--------------------------------------------------------------------------------------------------------------------------------------
...
delay_1s:
				ldi				delay_count, 62  ; 16ms x 62 = 0.992s
inner_delay_1s:
				rcall			delay_16ms
				dec				delay_count
				brne			inner_delay_1s
